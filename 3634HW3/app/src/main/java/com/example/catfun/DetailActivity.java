...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //this intent is to determine whether or not the cat is a favourite already
        ...
        //this request will get the information from the API and populate the details page
