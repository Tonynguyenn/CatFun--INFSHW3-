...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentTransaction.replace(R.id.fragment_slot, new SearchRecyclerFragment());
        ...
        if(id != null){
            ...
            Response.Listener<String> responseListener = new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    CatDetail catDetail = catDetailArrayList.get(0);
                    Cat[] catArrayObject = catDetail.getBreeds();
        ...
        BottomNavigationView buttonNavBar = (BottomNavigationView) findViewById(R.id.nav_view);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch(id){
                    case R.id.nav_search: {
                        fragmentManager.beginTransaction().replace(R.id.fragment_slot, new SearchRecyclerFragment()).commit();
                    } break;
                    case R.id.nav_favourites: {
                        fragmentManager.beginTransaction().replace(R.id.fragment_slot, new FavouritesRecyclerFragment()).commit();
                    } break;
                }
                return true;
            }
